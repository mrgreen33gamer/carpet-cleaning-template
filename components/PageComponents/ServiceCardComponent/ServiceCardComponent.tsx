...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Carpet Cleaning Needs',
  subheading = 'From emergency repairs to tile and grouts and area rugs, PureSoft Carpet Care handles it all — on time, on price.',
