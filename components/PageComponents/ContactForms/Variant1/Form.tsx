...
const SERVICES = [
  { icon: faWrench,          label: 'Carpet Cleaning' },
  { icon: faLink,            label: 'Upholstery Cleaning' },
  { icon: faDoorOpen,        label: 'Tile & Grout Cleaning' },
  { icon: faCogs,            label: 'Area Rug Cleaning' },
  { icon: faClipboardList,   label: 'Pet Odor Treatment' },
  { icon: faBuilding,        label: 'Commercial Carpet Care' },
  { icon: faBolt,            label: 'Commercial / Other' },
];
...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'IICRC · Insured' },
  { icon: faStar,         text: '4.9★ · 1,400+ reviews' },
];
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed PureSoft Carpet Care technician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12548303030"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 830-3030', section: 'ContactForm-V1' })}>
                          Call (254) 830-3030
                        </a>
                      </span>
                    </div>
