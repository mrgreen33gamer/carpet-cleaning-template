...
const SERVICES = [
  { icon: faWrench,        label: 'Carpet Cleaning',  sub: 'Wall-to-wall deep clean' },
  { icon: faLink,          label: 'Upholstery Cleaning',      sub: 'Sofas, chairs & fabric furniture' },
  { icon: faDoorOpen,      label: 'Tile & Grout Cleaning',    sub: 'Floors, kitchens & baths' },
  { icon: faCogs,          label: 'Area Rug Cleaning',      sub: 'Wool, synthetic & specialty rugs' },
  { icon: faClipboardList, label: 'Pet Odor Treatment',    sub: 'Enzyme treatment for urine odor' },
  { icon: faBuilding,      label: 'Commercial Carpet Care',    sub: 'Offices, multi-unit & medical' },
  { icon: faBolt,          label: 'Commercial / Other',           sub: 'Tell us what you need' },
];
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A licensed PureSoft Carpet Care tech will reach out about your <strong>{selectedService}</strong> service.
                  </p>
