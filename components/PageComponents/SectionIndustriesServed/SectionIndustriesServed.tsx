...
const INDUSTRIES = [
  ...
  { slug: 'homebuilders',          label: 'Hospitality', icon: faHardHat },
  { slug: 'commercial-facilities', label: 'Offices & Medical',     icon: faIndustry },
];
...
export default function SectionIndustriesServed({
  ...
  subtitle = 'Carpet cleaning programs — built for how your industry actually works.',
  disableLinks = false,
