...
const BlogPreviewGrid: React.FC<BlogPreviewGridProps> = ({
  title       = 'Carpet Care Tips & Insights',
  subtitle    = 'Practical carpet care advice for Central Texas homeowners — cleaning schedules, pet stains, and which method fits your home.',
  posts,
  count       = 4,
  viewAllLink = '/blogs',
