...
const SERVICE_LINKS = [
  ...
  { href: '/services/tile-grout',        label: 'Tile & Grout Cleaning' },
  { href: '/services/area-rugs',  label: 'Area Rug Cleaning' },
  { href: '/services/pet-odor-treatment',label: 'Pet Odor Treatment' },
  { href: '/services/commercial-carpet', label: 'Commercial Carpet Care' },
];
...
const TRUST_ITEMS = [
  ...
  { icon: faWrench,       label: 'IICRC-Certified' },
  { icon: faClock,        label: 'Same-Day Service' },
  { icon: faBolt,         label: 'Spot-Free Satisfaction Guarantee' },
];

const SOCIALS = [
  { href: 'https://facebook.com/puresoftcarpet', icon: faFacebookF, label: 'Facebook' },
  { href: 'https://g.page/r/puresoftcarpet',     icon: faGoogle,    label: 'Google' },
];
          ...
          <div className={styles.brandCol}>
            <Link href="/" className={styles.logo}>
              ...
              <div className={styles.logoText}>
                <span className={styles.logoName}>PureSoft Carpet Care</span>
                <span className={styles.logoSub}>Waco, Texas</span>
              </div>
            </Link>

            <p className={styles.tagline}>
              Deep Carpet · Upholstery · Tile Cleaning. Flat-rate pricing. IICRC-certified. Serving Central Texas since 2011.
            </p>

            <div className={styles.contactBlock}>
              <a href="tel:+12548303030" className={styles.phoneLink}
                onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Footer Phone', section: 'Footer-Brand' })}>
                <FontAwesomeIcon icon={faPhone} />
                (254) 830-3030
              </a>
              <a href="mailto:hello@puresoftcarpet.com" className={styles.emailLink}
                onClick={() => trackEvent({ eventType: 'email_click', elementLabel: 'Footer Email', section: 'Footer-Brand' })}>
                <FontAwesomeIcon icon={faEnvelope} />
                hello@puresoftcarpet.com
              </a>
              <span className={styles.addressLine}>
                <FontAwesomeIcon icon={faLocationDot} />
                2800 W Waco Dr, Waco, TX 76707
              </span>
            </div>

            <div className={styles.socials}>
              {SOCIALS.map(({ href, icon, label }) => (
                <Link key={label} href={href} target="_blank" rel="noarea rug noreferrer"
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            &copy; {new Date().getFullYear()} PureSoft Carpet Care. All Rights Reserved. | IICRC-Certified · Bonded & Insured
          </p>
          <a href="tel:+12548303030" className={styles.emergencyBtn}
            onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Same-Day Service', section: 'Footer-Bottom' })}>
